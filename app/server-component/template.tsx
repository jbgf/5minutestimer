  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        ...
        {!props.isHomePage && <span className="flex items-center cursor-pointer"><HomeIcon /> <a className="whitespace-nowrap" href="/" target="_blank" title="back to home page">5 minute timer</a></span>}
      </div>
